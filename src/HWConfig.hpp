...
struct ComBackend<uc_log::Tag::User>
  : public uc_log::DefaultRttComBackend<DbgPres, 32768, 1024, rtt::BufferMode::skip> {};
}   // namespace uc_log
...
struct Wiz_SPIConfig {
    static constexpr auto clockSpeed = ClockSpeed;

    static constexpr auto instance        = 0;
    static constexpr auto misoPinLocation = Pin::wiz_miso{};
    static constexpr auto mosiPinLocation = Pin::wiz_mosi{};
    static constexpr auto sclkPinLocation = Pin::wiz_sclk{};
    //static constexpr auto baudRate        = 1'000'000;
    static constexpr auto baudRate    = 33'250'000;
    static constexpr auto mode        = Kvasir::SPI::Mode::_3;
    static constexpr auto isrPriority = 1;
};

struct Adc_SPIConfig {
    static constexpr auto clockSpeed = ClockSpeed;

    static constexpr auto instance        = 1;
    static constexpr auto misoPinLocation = Pin::adc_miso{};
    static constexpr auto mosiPinLocation = Pin::adc_mosi{};
    static constexpr auto sclkPinLocation = Pin::adc_sclk{};
    static constexpr auto baudRate        = 1'000'000;
    static constexpr auto mode            = Kvasir::SPI::Mode::_1;
    static constexpr auto isrPriority     = 1;
}; */
